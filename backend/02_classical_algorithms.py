...
==========================
Classical Support Vector Machine (SVM) Research Baseline.
...
Experimental Methodology:
  ...
  - Hyperparameter Grid Search (C, gamma, degree)
  - Rigorous statistical metric reporting (mean +/- std across all 5 folds)
  - Full-feature & 4-component PCA representation evaluation (for 1:1 QSVM parity)
...
def generate_classical_markdown_report(cancer_res, cardio_res):
    """Generate Markdown report for classical baselines."""
    md = f"""# Classical SVM Baseline Benchmark Report
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **Linear SVM** | Full (30 features) | `{cancer_res['models_full_features']['linear']['best_params']}` | {cancer_res['models_full_features']['linear']['cv_summary']['accuracy_formatted']} | {cancer_res['models_full_features']['linear']['test_metrics']['accuracy']*100:.2f}% | {cancer_res['models_full_features']['linear']['test_metrics']['sensitivity']*100:.2f}% | {cancer_res['models_full_features']['linear']['test_metrics']['specificity']*100:.2f}% | {cancer_res['models_full_features']['linear']['test_metrics']['roc_auc']:.4f} |
| **RBF SVM** *(Primary)* | Full (30 features) | `{cancer_res['models_full_features']['rbf']['best_params']}` | {cancer_res['models_full_features']['rbf']['cv_summary']['accuracy_formatted']} | {cancer_res['models_full_features']['rbf']['test_metrics']['accuracy']*100:.2f}% | {cancer_res['models_full_features']['rbf']['test_metrics']['sensitivity']*100:.2f}% | {cancer_res['models_full_features']['rbf']['test_metrics']['specificity']*100:.2f}% | {cancer_res['models_full_features']['rbf']['test_metrics']['roc_auc']:.4f} |
| **Polynomial SVM** | Full (30 features) | `{cancer_res['models_full_features']['poly']['best_params']}` | {cancer_res['models_full_features']['poly']['cv_summary']['accuracy_formatted']} | {cancer_res['models_full_features']['poly']['test_metrics']['accuracy']*100:.2f}% | {cancer_res['models_full_features']['poly']['test_metrics']['sensitivity']*100:.2f}% | {cancer_res['models_full_features']['poly']['test_metrics']['specificity']*100:.2f}% | {cancer_res['models_full_features']['poly']['test_metrics']['roc_auc']:.4f} |
| **RBF SVM** *(QSVM Parity)* | 4-PCA Features | `{cancer_res['models_pca_features']['rbf']['best_params']}` | {cancer_res['models_pca_features']['rbf']['cv_summary']['accuracy_formatted']} | {cancer_res['models_pca_features']['rbf']['test_metrics']['accuracy']*100:.2f}% | {cancer_res['models_pca_features']['rbf']['test_metrics']['sensitivity']*100:.2f}% | {cancer_res['models_pca_features']['rbf']['test_metrics']['specificity']*100:.2f}% | {cancer_res['models_pca_features']['rbf']['test_metrics']['roc_auc']:.4f} |
...
| Kernel Type | Representation | Best Hyperparameters | 5-Fold CV Accuracy ($\\mu \\pm \\sigma$) | Test Accuracy | Test Sensitivity | Test Specificity | Test ROC-AUC |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **Linear SVM** | Full (13 features) | `{cardio_res['models_full_features']['linear']['best_params']}` | {cardio_res['models_full_features']['linear']['cv_summary']['accuracy_formatted']} | {cardio_res['models_full_features']['linear']['test_metrics']['accuracy']*100:.2f}% | {cardio_res['models_full_features']['linear']['test_metrics']['sensitivity']*100:.2f}% | {cardio_res['models_full_features']['linear']['test_metrics']['specificity']*100:.2f}% | {cardio_res['models_full_features']['linear']['test_metrics']['roc_auc']:.4f} |
| **RBF SVM** *(Primary)* | Full (13 features) | `{cardio_res['models_full_features']['rbf']['best_params']}` | {cardio_res['models_full_features']['rbf']['cv_summary']['accuracy_formatted']} | {cardio_res['models_full_features']['rbf']['test_metrics']['accuracy']*100:.2f}% | {cardio_res['models_full_features']['rbf']['test_metrics']['sensitivity']*100:.2f}% | {cardio_res['models_full_features']['rbf']['test_metrics']['specificity']*100:.2f}% | {cardio_res['models_full_features']['rbf']['test_metrics']['roc_auc']:.4f} |
| **Polynomial SVM** | Full (13 features) | `{cardio_res['models_full_features']['poly']['best_params']}` | {cardio_res['models_full_features']['poly']['cv_summary']['accuracy_formatted']} | {cardio_res['models_full_features']['poly']['test_metrics']['accuracy']*100:.2f}% | {cardio_res['models_full_features']['poly']['test_metrics']['sensitivity']*100:.2f}% | {cardio_res['models_full_features']['poly']['test_metrics']['specificity']*100:.2f}% | {cardio_res['models_full_features']['poly']['test_metrics']['roc_auc']:.4f} |
| **RBF SVM** *(QSVM Parity)* | 4-PCA Features | `{cardio_res['models_pca_features']['rbf']['best_params']}` | {cardio_res['models_pca_features']['rbf']['cv_summary']['accuracy_formatted']} | {cardio_res['models_pca_features']['rbf']['test_metrics']['accuracy']*100:.2f}% | {cardio_res['models_pca_features']['rbf']['test_metrics']['sensitivity']*100:.2f}% | {cardio_res['models_pca_features']['rbf']['test_metrics']['specificity']*100:.2f}% | {cardio_res['models_pca_features']['rbf']['test_metrics']['roc_auc']:.4f} |
...
def main():
    print("=" * 75)
    print(" 02_CLASSICAL_ALGORITHMS: CLASSICAL SVM RESEARCH BASELINE")
    print("=" * 75)
    create_directories()
    
    # 1. Breast Cancer Baseline
    cancer_res = evaluate_classical_svm_suite("cancer", "Breast Cancer Wisconsin Diagnostic")
    
    # 2. Cardiovascular Baseline
    cardio_res = evaluate_classical_svm_suite("cardiovascular", "UCI Heart Disease")
    
    # 3. Consolidated Markdown Report
    generate_classical_markdown_report(cancer_res, cardio_res)
