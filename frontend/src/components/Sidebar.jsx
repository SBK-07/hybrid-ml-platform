...
export default function Sidebar({ activeTab, setActiveTab, isBackendOnline = true }) {
  ...
  const navItems = [
    ...
    { id: 'inference', icon: <Activity size={18} />, label: 'Live Patient Risk Predictor' },
    { id: 'dataset-overview', icon: <Database size={18} />, label: 'Dataset Overview & EDA'},
    ...
    { id: 'real-qc', icon: <Cpu size={18} />, label: 'Real QC Hardware'},
